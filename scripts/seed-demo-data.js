...
const buildHeroes = (ids) => ([
  ...
  {
    id: "demo-hero-13",
    heroName: "Dr. Laila Hassan",
    location: "Casablanca",
    country: "Morocco",
    category: "Public Health",
    summary: "Built a mobile vaccination outreach program for rural villages.",
    impact: "Immunization rates increased by 28% across 16 communities.",
    status: "review",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    createdAt: daysAgo(2),
  ...
  {
    id: "demo-hero-14",
    heroName: "Jorge Mendel",
    location: "Lima",
    country: "Peru",
    category: "Community Medicine",
    summary: "Organized neighborhood clinics with local volunteers and med students.",
    impact: "2,300 residents received primary care screenings.",
    status: "claimed",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    journalistId: ids.journalist,
  ...
  {
    id: "demo-hero-15",
    heroName: "Anya Petrova",
    location: "Sofia",
    country: "Bulgaria",
    category: "Cultural Preservation",
    summary: "Digitized oral histories from elder artisans and community leaders.",
    impact: "120 stories archived and used in school curriculum.",
    status: "story_submitted",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    journalistId: ids.journalist,
    journalistName: "Journalist",
    claimedAt: daysAgo(11),
    storySubmittedAt: daysAgo(3),
  ...
  },
  {
    ...
    summary: "Designed a youth apprenticeship program for local enterprises.",
    impact: "180 graduates placed into paid apprenticeships.",
    status: "approved",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    journalistId: ids.journalist,
  ...
  {
    id: "demo-hero-17",
    heroName: "Sofia Alvarez",
    location: "Seville",
    country: "Spain",
    category: "Entrepreneurship",
    summary: "Launched a co-op marketplace for women-owned microbusinesses.",
    impact: "76 businesses increased monthly revenue by 35%.",
    status: "scheduled",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    journalistId: ids.journalist,
  ...
  },
  {
    ...
    country: "New Zealand",
    category: "Social Innovation",
    summary: "Built a community food resilience network for coastal towns.",
    impact: "Weekly meal delivery reached 900 households.",
    status: "published",
    ambassadorId: ids.ambassador,
    ambassadorName: "Ambassador",
    journalistId: ids.journalist,
...
const buildStories = (ids) => ([
  ...
  {
    id: "demo-story-5",
    heroProfileId: "demo-hero-15",
    heroName: "Anya Petrova",
    title: "Saving Heritage Through Digital Storytelling",
    content:
      "Anya Petrova built a volunteer network to record elder artisans and community leaders across Sofia. The archive now powers school lessons and local museum exhibits, protecting cultural heritage for the next generation.",
    journalistId: ids.journalist,
    journalistName: "Journalist",
    status: "submitted",
    createdAt: daysAgo(5),
  ...
  {
    id: "demo-story-6",
    heroProfileId: "demo-hero-18",
    heroName: "Noah Kim",
    title: "The Coastal Food Network Keeping Families Fed",
    content:
      "Noah Kim partnered with farmers and community kitchens to launch a food resilience network in Auckland. The program now delivers weekly meals to 900 households and trains local coordinators to expand coverage.",
    journalistId: ids.journalist,
    journalistName: "Journalist",
    status: "approved",
    createdAt: daysAgo(12),
...
const buildAiContent = () => ([
  ...
  },
  {
    ...
    heroProfileId: "demo-hero-15",
    heroName: "Anya Petrova",
    storyId: "demo-story-5",
    platform: "linkedin",
    contentType: "summary",
    content:
      "Anya Petrova is preserving Sofia's cultural heritage by digitizing oral histories from elders and artisans. The archive now supports school curriculum and museum exhibits, ensuring local stories live on.",
    hashtags: ["CulturalPreservation", "Storytelling", "CommunityHeritage"],
    status: "pending",
    createdAt: daysAgo(1),
  },
  {
    ...
    heroProfileId: "demo-hero-18",
    heroName: "Noah Kim",
    storyId: "demo-story-6",
    platform: "instagram",
    contentType: "post",
    content:
      "Noah Kim built a coastal food network that now delivers weekly meals to 900 households. Local farmers, kitchens, and volunteers power a resilient community lifeline.",
    hashtags: ["FoodResilience", "SocialImpact", "LocalHeroes"],
    status: "approved",
    createdAt: daysAgo(2),
    approvedAt: daysAgo(1),
  },
