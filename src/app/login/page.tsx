          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-slate-950 text-slate-400">Demo Autofill</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              {DEMO_USERS.map((demo) => (
                <button
                  ...
                  disabled={isLoading}
                  className="flex items-center justify-between p-3 rounded-lg border border-slate-700 bg-slate-800/50 hover:bg-slate-800 hover:border-slate-600 transition-all text-left disabled:opacity-50"
                >
                  <div>
                    <div className="font-medium text-white">{demo.role}</div>
                    <div className="text-xs text-slate-400">Fill credentials</div>
                  </div>
